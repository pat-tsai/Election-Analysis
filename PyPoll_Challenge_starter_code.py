...
with open(file_to_save, "w") as txt_file:
    ...
    for county in county_options:
        ...
        county_votes_percentage = votes / total_votes * 100
        ...
        if county_votes_percentage > highest_county_turnout:
            highest_county_turnout = county_votes_percentage
            highest_county_name = county
